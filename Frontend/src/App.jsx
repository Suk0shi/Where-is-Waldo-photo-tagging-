...
function App() {
  ...
  function submitAnswer(e, target) {
    e.preventDefault()
    fetch(`http://localhost:3000/checkcoordinate`, {
        method: 'Post', 
        headers: {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`http://localhost:3000/addLeaderboard`, {
        method: 'Post', 
        headers: {
          'Authorization': `${localStorage.getItem('SavedToken')}`,
          Accept: 'application/json',
...
//make it so that you can post all target choices at the same time 
//somehow figure out how to time 